...
public class MimeDirectoryImporterNodeFactory extends NodeFactory<MimeDirectoryImporterNodeModel> {
     ...
     */
    @Override
    public MimeDirectoryImporterNodeModel createNodeModel() {
     ...
     */
    @Override
    public NodeView<MimeDirectoryImporterNodeModel> createNodeView(final int viewIndex, final MimeDirectoryImporterNodeModel nodeModel) {
        return null;
    }
