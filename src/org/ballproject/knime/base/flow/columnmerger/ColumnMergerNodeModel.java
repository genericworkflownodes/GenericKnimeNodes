...
public class ColumnMergerNodeModel extends NodeModel
{
	...
	// the logger instance
	private static final NodeLogger logger = NodeLogger.getLogger(ColumnMergerNodeModel.class);
	...
	private void fill(DataCell cell, BufferedDataContainer cont, List<MIMEFileCell> list)
	{
	...
	{
		// get data type of first columns (where the MIMEFileCell is stored by convention)
	...
	private DataTableSpec getDataTableSpec(boolean collection) throws InvalidSettingsException
	{
		...
		{
			allColSpecs[0]   =  new DataColumnSpecCreator("column 0",  inType).createSpec();
		}
