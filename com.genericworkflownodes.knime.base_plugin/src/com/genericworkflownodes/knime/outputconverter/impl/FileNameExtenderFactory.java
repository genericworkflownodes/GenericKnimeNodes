...
/**
 * Factory to create {@link FileNameExtender} {@link IOutputConverter}.
 * 
 * @author aiche
 */
public class FileNameExtenderFactory implements IOutputConverterFactory {

	@Override
	public IOutputConverter create(final Properties properties) {
		return new FileNameExtender(properties);
	}
